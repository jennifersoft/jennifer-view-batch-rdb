...
public abstract class InstanceForBase implements Batch, IDataLegacy {
    ...
    public String getTableName(long batchTime) {
        ...
        return PropertyUtil.getValue(getExtensionId(), "table", "METRICS_AS_INSTANCE") + "_" + sdf.format(new Date(batchTime));
    }
