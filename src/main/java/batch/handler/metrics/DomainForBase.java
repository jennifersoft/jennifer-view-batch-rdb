    ...
    public void process(BatchData[] models) {
        ...
        try {
            ...
            for(int i = 0; i < models.length; i++) {
                ...
                statement.setTimestamp(3, new Timestamp(data.standardTime));
                statement.setDouble(4, data.aliveInstanceCount);
                statement.setDouble(5, data.serviceCount);
                statement.setDouble(6, data.serviceTime);
                statement.setDouble(7, data.serviceErrorCount);
                statement.setDouble(8, data.serviceSlowCount);
                statement.setDouble(9, data.serviceMethodTime);
                statement.setDouble(10, data.serviceSqlTime);
                statement.setDouble(11, data.serviceExternalCallTime);
                statement.setDouble(12, data.serviceFetchTime);
                statement.setDouble(13, data.serviceRate);
                statement.setDouble(14, data.activeService);
                statement.setDouble(15, data.userRequestInterval);
                statement.setDouble(16, data.concurrentUser);
                statement.setDouble(17, data.visitHour);
                statement.setDouble(18, data.visitDay);
                ...
                statement.setDouble(33, data.averageDbPoolActiveCount);
                statement.setDouble(34, data.averageDbPoolIdleCount);
                statement.setDouble(35, data.averageDbPoolConfiguredCount);
                statement.setDouble(36, data.maxDbPoolActiveCount);
                statement.setDouble(37, data.maxTps);
                statement.addBatch();
